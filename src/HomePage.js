...
let HomePage=()=>{
    return(
        <div className='enlightenedDiv'>
            <Container maxWidth='lg'className='aLittleMargin'>
                            ...
                            <CardActionArea>
                                ...
                                <CardContent>
                                    ...
                                    <Typography variant='h6'color='textPrimar'component='h6'>
                                        Recent graduate of UCF's Full Stack Web Development Program powered by 2U inc; in which the primary focus was gaining proficiency within the MERN stack. Software engineering is something I took to because of the highly creative nature invoved in programmatically finding solutions.
                                    </Typography>
                                </CardContent>
                            </CardActionArea>
